...
<h5 class="m-b-10">Ducoments</h5>
</div>
<ul class="breadcrumb">
<li class="breadcrumb-item"><a href="home.php"><i class="feather icon-home"></i></a></li>
<li class="breadcrumb-item"><a href="javascript:">All Ducoments</a></li>
</ul>
</div>
</div>
</div>
...
<!--  -->
<li class="nav-item">
<a class="nav-link" href="Documents.php">Resignation</a>
</li>
<!--  -->
<li class="nav-item">
<a class="nav-link active" href="#">Approved Resignation</a>
</li>
<!--  -->
<li class="nav-item">
<a class="nav-link" href="resign_rejected.php">Rejected Resignation</a>
</li>
</ul>
...
<?php
// $sql = "SELECT * FROM employees JOIN resignation WHERE employees.id = resignation.emp_id AND resignation.team_m_approval = 'approved' AND resignation.hr_approval = 'approved' ";
$sql = "SELECT * FROM employees JOIN resignation WHERE employees.id = resignation.emp_id";
...
if (($row['role'] == 'Team-Manager' AND $row['team_m_approval'] == '' AND $row['hr_approval'] == 'approved') || ( $row['role'] == 'Employee' AND $row['team_m_approval'] == 'approved' AND $row['hr_approval'] == 'approved' )) {
...
<a href="approved_resign_details.php?approved_details=<?php  echo $row['r_id'];?>" data-toggle="tooltip" title="View"> 
...
$sql = "SELECT * FROM employees JOIN resignation WHERE employees.id = resignation.emp_id AND resignation.team_m_approval = 'approved' AND resignation.hr_approval = 'approved' AND resignation.department = '$department' ";
...
<a href="leaveformedit.php?formedit=<?php  //echo $row['leave_id'];?>" data-toggle="tooltip" title="View"> 
<i class="feather icon-file" aria-hidden="true"></i>
</a>
