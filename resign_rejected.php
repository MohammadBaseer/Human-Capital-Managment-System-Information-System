...
<?php
$sql = "SELECT * FROM employees JOIN resignation WHERE employees.id = resignation.emp_id AND (resignation.team_m_approval = 'rejected' OR resignation.hr_approval = 'rejected') ";
...
<a href="resign_rejected_details.php?rejected_details=<?php  echo $row['r_id'];?>" data-toggle="tooltip" title="View"> 
...
$sql = "SELECT * FROM employees JOIN resignation WHERE employees.id = resignation.emp_id  AND resignation.department = '$department' AND (resignation.team_m_approval = 'rejected' OR resignation.hr_approval = 'rejected') ";
