...
<?php 
$date = date("Y-m-d");
$sql = "SELECT * FROM job_t WHERE remark = 'unpublished' || close_date < '$date' "; 
...
<!-- <td><?php echo $row['announcement_status']; ?></td> -->
<!--       <td>20 Users</td>
<td>40 CV's</td> --> 
<!-- <td>&nbsp; &nbsp; 
<a href="publish.php?publish=<?php //echo $row['job_id'];?>" data-toggle="tooltip" title="Publish">
<i class="feather icon-upload-cloud" aria-hidden="true"></i>
</a>&nbsp; &nbsp;
<a href=""  data-toggle="tooltip" title="Archive"> 
<i class="feather icon-archive" aria-hidden="true"></i>
</a>&nbsp; &nbsp;
<a href=""  data-toggle="tooltip" title="Details"> 
