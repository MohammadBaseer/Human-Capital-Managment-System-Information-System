...
<!--  -->
<li class="nav-item">
<a class="nav-link" href="resign_approved.php">Approved Resignation</a>
</li>
<!--  -->
<li class="nav-item">
...
// $sql = " SELECT *, b.* FROM employees a, resignation b WHERE a.id = b.emp_id AND b.team_m_approval = 'approved' AND b.hr_approval = '')  " ;
$sql = " SELECT *, b.* FROM employees a, resignation b WHERE a.id = b.emp_id ";
...
if (($row['role'] == 'Team-Manager' AND $row['team_m_approval'] == '' AND $row['hr_approval'] == '') || ( $row['role'] == 'Employee' AND $row['team_m_approval'] == 'approved' AND $row['hr_approval'] == '' )) {
echo "<tr>";
// echo "1";
}
else
...
$sql = "SELECT * FROM employees JOIN resignation WHERE employees.id = resignation.emp_id AND resignation.team_m_approval = '' AND resignation.hr_approval = '' AND resignation.department = '$department' AND resignation.emp_id != '$my_id' ";
...
<a href="resign_detail.php?tm_detail=<?php  echo $row['r_id'];?>" data-toggle="tooltip" title="View"> 
<i class="feather icon-file" aria-hidden="true"></i>
</a>
