...
<!--  -->
<li class="nav-item">
<a class="nav-link" href="hr_leave_approval.php">HR Approval</a>
</li>
<!--  -->
<li class="nav-item">
...
<!--  -->
<li class="nav-item">
<a class="nav-link active" href="all_employees_approved_leaves.php">Staff Rejected</a>
</li>
</ul>
...
$sql = "SELECT * FROM leave_forms as l INNER JOIN employees as e on l.employee_id = e.id  INNER JOIN department AS d ON e.department_id = d.departmentid WHERE manager_sign= 'rejected' || hr_sign = 'rejected' ";
