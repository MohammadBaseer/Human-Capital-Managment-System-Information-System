...
<!--  -->
<li class="nav-item">
<a class="nav-link active" href="#">Leave Management</a>
</li>
<!--  -->
<li class="nav-item">
<a class="nav-link" href="my_approved_leaves.php">Approved</a>
</li>
<!--  -->
<li class="nav-item">
...
$user = $auth['user'];
$sql = "SELECT * FROM leave_forms as l INNER JOIN employees as e on l.employee_id = e.id  INNER JOIN department AS d ON e.department_id = d.departmentid WHERE  department_id = departmentid AND department_id= '$department' AND user='$user' AND NOT manager_sign='rejected' AND hr_sign = '' ";
...
echo "<span class='label theme-bg2 f-12 text-white'> Pending </span>";
}
?> 
</td>
...
<?php 
if ($row['manager_sign'] !== "approved") {
?>
<!-- <a href="leaveformedit.php?formedit=<?php //echo $row['leave_id'];?>">
<a href="leaveformedit.php?formedit=<?php  //echo $row['leave_id'];?>" data-toggle="tooltip" title="Edit"> 
<i class="feather icon-edit-1" aria-hidden="true"></i> -->
</a>&nbsp;&nbsp;
<a href="controller/href_controller.php?delete=<?php echo $row['leave_id'];?>" onclick="return confirm('Are you sure..?');" data-toggle="tooltip" title="Delete">
...
<div class="col-sm-12">
<a href="leave_form.php">
<button type="submit" name="submit" class="btn btn-primary">Submit New Form</button>
</a><br><br>
</div>
</div>
<!-- ======================= -->
