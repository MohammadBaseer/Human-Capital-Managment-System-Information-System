...
$trn_date = date("Y-m-d H:i:s");
	...
	if(empty($_POST["password"]) || empty($_POST["emp_type"]))  
	{
		$sql = "UPDATE employees SET role = '$emp_type', date_modify = '$trn_date' WHERE id= $id";
...
echo "<script>window.location='user_administration.php'</script>";
			...
			$sql = "UPDATE employees SET  password = '".SHA1($password)."', role = '$emp_type', date_modify = '$trn_date' WHERE id= $id";
