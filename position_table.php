...
$sql = "INSERT INTO position (position) VALUES (?);";
...
<div class="input-group">             
 <input type="text" name="position" value="<?php echo @$row['position']; ?>" placeholder="position Name" class="form-control" style=" height: 35px; float: right;">
</div>
</div>
                ...
                <tbody>       
                  ...
                  while($row = mysqli_fetch_assoc($result)){
                    ...
                    <tr>
                      ...
                      <td><a href="?positionedit=<?php echo $row['positionid'];?>" data-toggle="tooltip" title="Edit">
                        <i class="feather icon-edit-1" aria-hidden="true"></i>
                      </a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      <a class="delete"  href="?positiondelete=<?php echo $row['positionid'];?>" onclick="return confirm('Are you sure..?')" data-toggle="tooltip" title="Delete">
