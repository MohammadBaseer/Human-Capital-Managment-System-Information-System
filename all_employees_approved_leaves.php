...
<!--  -->
<li class="nav-item">
<a class="nav-link active" href="#">Staff Approved</a>
</li>
<!--  -->
<li class="nav-item">
...
$sql = "SELECT * FROM leave_forms as l INNER JOIN employees as e on l.employee_id = e.id  INNER JOIN department AS d ON e.department_id = d.departmentid WHERE manager_sign= 'approved' AND hr_sign = 'approved' ";
