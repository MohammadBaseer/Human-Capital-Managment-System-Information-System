...
<h5>Department Approved Leaves</h5>
...
$sql = "SELECT * FROM leave_forms as l INNER JOIN employees as e on l.employee_id = e.id  INNER JOIN department AS d ON e.department_id = d.departmentid WHERE department= '$department' AND manager_sign = 'approved' AND hr_sign = 'approved' ";
...
<td>
<?php if($row['hr_sign'] == "approved" && $row['manager_sign'] == "approved"){
