...
<?php 
$user_id = $auth['id'];
$sqlr = "SELECT * FROM leave_forms as l INNER JOIN employees as e on l.employee_id = e.id  INNER JOIN department AS d ON e.department_id = d.departmentid WHERE employee_id = '$user_id' AND (manager_sign = 'rejected' || hr_sign = 'rejected') ";
...
<td>
<?php if($row['manager_sign'] == "rejected"){
