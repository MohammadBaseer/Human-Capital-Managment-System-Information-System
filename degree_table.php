...
if(empty($_POST["degree"]))  
  ...
  $sql = " SELECT * FROM degree WHERE degree='$degree'";
...
<input type="text" name="degree" value="<?php echo @$row['degree']; ?>" placeholder="degree Name" class="form-control" style=" height: 35px; float: right;">
</div>
</div>
<div class="clearfix"> </div>
</div><br><br>
<div class="col-md-12 form-group">
<button type="submit" name="submit_degree" class="btn btn-primary" >Add</button>
...
<td><a href="?degreeedit=<?php echo $row['degreeid'];?>" data-toggle="tooltip" title="Edit">
<i class="feather icon-edit-1" aria-hidden="true"></i>
</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<a class="delete"  href="?degreedelete=<?php echo $row['degreeid'];?>" onclick="return confirm('Are you sure..?')" data-toggle="tooltip" title="Delete">
